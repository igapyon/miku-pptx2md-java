...
The upstream semantic source is the TypeScript / Node.js main application:

- Repository: `git@github.com:igapyon/miku-pptx2md.git`
- Local checkout: `/Users/igapyon/Documents/git/miku-pptx2md`
